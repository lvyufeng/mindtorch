...
import mindtorch.return_types
from mindtorch.utils._pytree import PyTree, tree_flatten, TreeSpec
...
for return_type in mindtorch.return_types.all_return_types:
    register_pytree_flatten_spec(
        return_type,
        _tuple_flatten_spec,
        _tuple_flatten_spec_exact_match,
