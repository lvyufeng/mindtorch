...
import mindtorch
from mindtorch.utils.data.distributed import DistributedSampler
...
class ElasticDistributedSampler(DistributedSampler):
    ...
    :class:`mindtorch.nn.parallel.DistributedDataParallel`. In such case, each
    ...
    def __iter__(self):
        ...
        indices = (
            mindtorch.randperm(len(self.dataset) - self.start_index, generator=g)  # type: ignore[arg-type]
