...
import mindtorch
import mindtorch.nn
from mindtorch._guards import detect_fake_mode
from mindtorch.autograd.graph import register_multi_grad_hook
from mindtorch.distributed._tools.mod_tracker import ModTracker
from mindtorch.distributed.tensor._api import DTensor
from mindtorch.nn.modules.module import (
    register_module_forward_hook,
    register_module_forward_pre_hook,
    register_module_full_backward_pre_hook,
)
from mindtorch.utils._python_dispatch import TorchDispatchMode
from mindtorch.utils._pytree import tree_flatten


__all__ = ["CommDebugMode"]

funcol_native = mindtorch.ops._c10d_functional
funcol_py = mindtorch.ops.c10d_functional
funcol_autograd = mindtorch.ops._c10d_functional_autograd
c10d_ops = mindtorch.ops.c10d
...
class _CommModeModuleTracker(ModTracker):
    ...
    def _fw_pre_hook(self, mod, input):
        ...
        tensors = [a for a in args if isinstance(a, mindtorch.Tensor) and a.requires_grad]
...
class CommDebugMode(TorchDispatchMode):
    ...
    def __init__(self):
        ...
        self.comm_registry.add(mindtorch.ops._dtensor.shard_dim_alltoall)
