...
import mindtorch
from mindtorch.nn.modules.batchnorm import _BatchNorm
...
class MixedPrecision:
    ...
    Attributes:
        param_dtype (Optional[mindtorch.dtype]): This specifies the dtype for model
        ...
        reduce_dtype (Optional[mindtorch.dtype]): This specifies the dtype for
            ...
            ``None``)
        buffer_dtype (Optional[mindtorch.dtype]): This specifies the dtype for
    ...
    .. note:: For nested FSDP instances with different ``MixedPrecision``
        ...
        Example::
            ...
            >>> model[1] = FSDP(
            >>>     model[1],
            >>>     mixed_precision=MixedPrecision(param_dtype=mindtorch.float16, cast_forward_inputs=True),
            >>> )
            >>> model = FSDP(
            >>>     model,
            >>>     mixed_precision=MixedPrecision(param_dtype=mindtorch.bfloat16, cast_forward_inputs=True),
            >>> )
    ...
    param_dtype: Optional[mindtorch.dtype] = None
    reduce_dtype: Optional[mindtorch.dtype] = None
    buffer_dtype: Optional[mindtorch.dtype] = None
    keep_low_precision_grads: bool = False
    cast_forward_inputs: bool = False
    cast_root_forward_inputs: bool = True
    _module_classes_to_ignore: Sequence[Type[mindtorch.nn.Module]] = (_BatchNorm,)
...
class FullStateDictConfig(StateDictConfig):
    ...
    follows:
        ...
        >>>     state_dict = mindtorch.load("my_checkpoint.pt")
        >>>     model.load_state_dict(state_dict)
        >>> # All ranks initialize FSDP module as usual. `sync_module_states` argument
        >>> # communicates loaded checkpoint states from rank 0 to rest of the world.
        >>> fsdp = FSDP(model, device_id=mindtorch.cuda.current_device(), auto_wrap_policy=..., sync_module_states=True)
