    ...
    *, wrapper_cls: Any, **wrapper_kwargs: Any
    ...
    Usage::
        ...
        with enable_wrap(wrapper_cls, **params):
            ...
            self.l1 = wrap(mindtorch.nn.Linear(5, 5))
...
def _recursive_wrap(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        ignored_modules (Set[mindtorch.nn.Module]): Modules to ignore when
            wrapping.
        ignored_params (Set[mindtorch.nn.Parameter]): Parameters to ignore when
