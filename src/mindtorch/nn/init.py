...
def uniform_(
    ...
    a: float = 0.0,
    b: float = 1.0,
    generator: _Optional[mindtorch.Generator] = None,
) -> Tensor:
    ...
    Args:
        tensor: an n-dimensional `mindtorch.Tensor`
        a: the lower bound of the uniform distribution
        b: the upper bound of the uniform distribution

    Examples:
        >>> w = mindtorch.empty(3, 5)
        >>> nn.init.uniform_(w)
    """
...
def dirac_(tensor, groups=1):
    ...
    Args:
        tensor: a {3, 4, 5}-dimensional `mindtorch.Tensor`
        groups (int, optional): number of groups in the conv layer (default: 1)
    Examples:
        >>> w = mindtorch.empty(3, 16, 5, 5)
        >>> nn.init.dirac_(w)
        >>> w = mindtorch.empty(3, 24, 5, 5)
        >>> nn.init.dirac_(w, 3)
    """
...
def orthogonal_(
    ...
    Args:
        tensor: an n-dimensional `mindtorch.Tensor`, where :math:`n \geq 2`
    ...
    q, r = mindtorch.linalg.qr(flattened)
    # Make Q uniform according to https://arxiv.org/pdf/math-ph/0609050.pdf
    d = mindtorch.diag(r, 0)
    ph = d.sign()
    q *= ph
...
def sparse_(
    ...
    with mindtorch.no_grad():
        ...
        for col_idx in range(cols):
            row_indices = mindtorch.randperm(rows)
