...
from mindtorch.distributed.tensor.debug import CommDebugMode
from mindtorch.distributed.tensor.parallel import (
    ColwiseParallel,
    parallelize_module,
    RowwiseParallel,
)
from mindtorch.testing._internal.distributed._tensor.common_dtensor import (
    MLPModule,
    MLPStacked,
    ModelArgs,
    NUM_DEVICES,
...
from mindtorch.utils.checkpoint import checkpoint
...
c10d_functional = mindtorch.ops.c10d_functional
...
class CommDebugModeExample:
    ...
    def _MLP_model_setup(
    ...
    ) -> tuple[nn.Module, mindtorch.Tensor]:
        """
        ...
        device_mesh = DeviceMesh(
            self.device_type,
            mindtorch.arange(0, NUM_DEVICES),
        )

        inp_size = [8, 10]
        inp = mindtorch.rand(*inp_size, device=self.device_type)
    ...
    def _transformer_model_setup(
        ...
        inp = mindtorch.randint(model_args.vocab_size, inp_size, device=self.device_type)
    ...
    def example_MLP_operation_tracing(self) -> None:
        ...
        Global
          ...
          BACKWARD PASS
            **aten.expand.default
            MLPModule
            *module type: class 'mindtorch.testing._internal.distributed._tensor.common_dtensor.MLPModule'
              FORWARD PASS
                *c10d_functional.all_reduce: 1
                **aten.view.default
                **aten.view.default
                **aten.view.default
                MLPModule.net1
                *module type: class 'mindtorch.nn.modules.linear.Linear'
                *Parameter List
                *weight: (Shard(dim=0),)
                *bias: (Shard(dim=0),)
                  FORWARD PASS
                    **aten.detach.default
                      shape: [mindtorch.Size([16, 10])]
                    ...
                    **aten.t.default
                    **aten.addmm.default
                      shape: [mindtorch.Size([16]), mindtorch.Size([8, 10]), mindtorch.Size([10, 16])]
                  ...
                  BACKWARD PASS
                    **aten.t.default
                      shape: [mindtorch.Size([8, 16])]
                      sharding: [(Shard(dim=1),)]
                      device mesh: DeviceMesh([0, 1, 2, 3])
                    **aten.t.default
                    **aten.mm.default
                      shape: [mindtorch.Size([16, 8]), mindtorch.Size([8, 10])]
                    ...
                    **aten.detach.default
                MLPModule.relu
                *module type: class 'mindtorch.nn.modules.activation.ReLU'
                  FORWARD PASS
                    **aten.view.default
                    **aten.relu.default
                    **aten.detach.default
                ...
                *bias: (Replicate(),)
                  FORWARD PASS
                    ...
                    **aten.t.default
                    **aten.addmm.default
                      shape: [mindtorch.Size([10]), mindtorch.Size([8, 16]), mindtorch.Size([16, 10])]
                  ...
                  BACKWARD PASS
                    ...
                    **aten.t.default
                    **aten.mm.default
                      shape: [mindtorch.Size([8, 10]), mindtorch.Size([10, 16])]
                      sharding: [(Replicate(),), (Shard(dim=1),)]
                      device mesh: DeviceMesh([0, 1, 2, 3])
                    **aten.mm.default
                    **aten.t.default
                      shape: [mindtorch.Size([8, 10])]
                      sharding: [(Replicate(),)]
                      device mesh: DeviceMesh([0, 1, 2, 3])
                    **aten.t.default
                    **aten.mm.default
                      shape: [mindtorch.Size([10, 8]), mindtorch.Size([8, 16])]
                      sharding: [(Replicate(),), (Shard(dim=1),)]
                      device mesh: DeviceMesh([0, 1, 2, 3])
                    **aten.mm.default
                    **aten.t.default
    ...
    def example_activation_checkpointing(self) -> None:
        ...
        class Foo(mindtorch.nn.Module):
            def __init__(self, n_layers: int, dim: int, use_ac: bool = False):
                super().__init__()
                self.linears = mindtorch.nn.ModuleList()
                self.use_ac = use_ac
                for _ in range(n_layers):
                    self.linears.append(mindtorch.nn.Linear(dim, dim))
            ...
            def forward(self, x: mindtorch.Tensor) -> mindtorch.Tensor:
                for i, block in enumerate(self.linears):
                    ...
                    x = mindtorch.nn.functional.relu(x)
                return x
