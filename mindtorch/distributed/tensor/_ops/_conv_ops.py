...
from mindtorch.distributed.tensor._op_schema import OpSchema, OutputSharding
from mindtorch.distributed.tensor._ops.utils import register_prop_rule
...
def convolution_rules(op_schema: OpSchema) -> OutputSharding:
    ...
    assert isinstance(weight_shape, mindtorch.Size)
