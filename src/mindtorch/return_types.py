...
import mindtorch
from mindtorch.utils._pytree import register_pytree_node, SequenceKey
...
return_types = {}  # type: ignore[attr-defined]
...
for name in dir(return_types):
    ...
    # Today everything in mindtorch.return_types is a structseq, aka a "namedtuple"-like
