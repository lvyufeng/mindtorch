...
from mindtorch._subclasses import FakeTensorMode
...
class ShardingPropagator:
    ...
    def _propagate_tensor_meta_non_cached(
        ...
        if isinstance(fake_out, mindtorch.Tensor):
            return TensorMeta(
            ...
            for fake_out_item in fake_out:
                if isinstance(fake_out_item, mindtorch.Tensor):
    ...
    def propagate(self, op_info: OpInfo) -> None:
        ...
        # This is generally ok because this only happens during tracing in mindtorch.compile,
