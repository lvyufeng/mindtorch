...
from mindtorch.distributed.tensor.placement_types import Placement, Shard
...
def _compute_local_shape_and_global_offset(
    ...
    """
    Same as mindtorch.distributed._tensor._utils.compute_local_shape_and_global_offset but
