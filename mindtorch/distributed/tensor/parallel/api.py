...
from mindtorch.distributed.tensor.parallel._utils import _validate_tp_mesh_dim
...
def parallelize_module(  # type: ignore[return]
    ...
    """
    mindtorch._C._log_api_usage_once("mindtorch.distributed.tensor.parallel.parallelize_module")
